...
This is a Node.js client SDK for [pip-services-sms](https://github.com/pip-services-users/pip-services-sms-node) microservice.
...
var client = sdk.SmsHttpClient(config);
